...
<head>
	<title>1st Bookstore for Muslims</title>
	<meta charset="utf-8">
					...
					<div class="row">
						<div class="col">
							<div class="header_content d-flex flex-row align-items-center justify-content-start">
								<div class="logo"><a href="index.php">Tiga Delapan Book Store</a></div>
								<nav class="main_nav">
									<ul>
								...
								<div class="row">
									<div class="col">
										<div class="home_slider_content" data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
											...
											<div class="home_slider_subtitle">Selamat Datang di Tiga Delapan Book Store</div>
				...
				<div class="row icon_box_row">
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							...
							<div class="icon_box_text">
								<p>Gratis Ongkir Pulau Jawa Non Minimum Selama Periode Desember 2018.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							...
							<div class="icon_box_text">
								<p>Khawatir buku tidak cocok? Jangan khawatir, karena apapun alasannya retur di Tiga Delapan Book Store gratis & mudah!</p>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col">
						<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
							<div class="footer_logo"><a href="index.php">Tiga Delapan Book Store</a></div>
							<div class="copyright ml-auto mr-auto">
								<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
								Copyright &copy;<script>
									document.write(new Date().getFullYear());
								</script> All rights reserved | Tiga Delapan Book Store <br>
